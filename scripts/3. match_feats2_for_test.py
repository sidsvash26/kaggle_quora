...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  8 20:35:43 2017
...
test = pd.read_csv('../../kaggle_quora_data/test.csv')
...
#took around 5-6 hours to run
test_X2 = np.vstack(np.array(test.apply(lambda row: feats_match(row), axis=1)))

pickle.dump(test_X2, open('../../kaggle_quora_data/feats2_match_test.sav', 'wb'))
