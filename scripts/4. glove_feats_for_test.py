...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  9 10:33:13 2017
...
t0 = time.time()
test_X3 = np.vstack(np.array(test.apply(lambda row: feats_glove(row), axis=1)))
pickle.dump(test_X3, open('../../kaggle_quora_data/feats3_glove_test.sav', 'wb'))
